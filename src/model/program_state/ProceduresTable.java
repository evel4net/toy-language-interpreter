...
public class ProceduresTable implements IProceduresTable {
    private Map<String, Pair<List<String>, Statement>> proceduresTable = new ConcurrentHashMap<>();

    public synchronized void addNewProcedure(String name, List<String> formalParameters, Statement body) throws KeyAlreadyExistsException {
...
//    }
    ...
    public synchronized Pair<List<String>, Statement> getPair(String procedure) throws KeyNotDefinedException {
    ...
    public synchronized Map<String, Pair<List<String>, Statement>> getContent() {
