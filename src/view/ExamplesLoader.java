...
import model.statements.semaphore_operations.CreateSemaphoreStatement;
...
public class ExamplesLoader {
    ...
    public ExamplesLoader() {
        ...
        // Example 13: Count Semaphore Mechanism
        /*
        Ref int v1; int cnt;
        ...
        Statement example13 = new CompoundStatement(
                ...
                new CompoundStatement(
                        ...
                        new CompoundStatement(
                                new AllocateHeapStatement("v1", new ValueExpression(new IntValue(1))),
                                new CompoundStatement(
